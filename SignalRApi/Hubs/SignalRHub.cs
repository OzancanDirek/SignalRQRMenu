...
{
    public class SignalRHub : Hub //uygulamanınn server kısmını kullanıcam burada
    {
        ...
        public async Task SendNotification()
        {
            ...
            await Clients.All.SendAsync("ReceiveNotificationCountByFalse", count);
